...
const PLANTILLAS_PEDIDO: PlantillaPedido[] = [
    ...
    },
    {
        ...
        nombre: 'Laboratorio Completo Bariátrico',
        especialidad: 'Cirugía',
        diagnosticoDefecto: 'Control de laboratorio bariátrico',
        estudios: [
            { descripcion: 'Hematocrito', diagnostico: 'control de laboratorio' },
            { descripcion: 'Hemoglobina (Hb)', diagnostico: 'control de laboratorio' },
            { descripcion: 'Leucocitos', diagnostico: 'control de laboratorio' },
            { descripcion: 'Glucosa en ayunas', diagnostico: 'control de laboratorio' },
            { descripcion: 'Glucosa 120\' (post-carga)', diagnostico: 'control de laboratorio' },
            { descripcion: 'Insulina', diagnostico: 'control de laboratorio' },
            { descripcion: 'HOMA', diagnostico: 'control de laboratorio' },
            { descripcion: 'Hemoglobina glicosilada (HbA1c)', diagnostico: 'control de laboratorio' },
            { descripcion: 'Colesterol Total', diagnostico: 'control de laboratorio' },
            { descripcion: 'Colesterol HDL', diagnostico: 'control de laboratorio' },
            { descripcion: 'Colesterol LDL', diagnostico: 'control de laboratorio' },
            { descripcion: 'Triglicéridos', diagnostico: 'control de laboratorio' },
            { descripcion: 'Urea', diagnostico: 'control de laboratorio' },
            { descripcion: 'Creatinina', diagnostico: 'control de laboratorio' },
            { descripcion: 'GOT', diagnostico: 'control de laboratorio' },
            { descripcion: 'GPT', diagnostico: 'control de laboratorio' },
            { descripcion: 'FAL (Fosfatasa Alcalina)', diagnostico: 'control de laboratorio' },
            { descripcion: 'Bilirrubina Total (BT)', diagnostico: 'control de laboratorio' },
            { descripcion: 'Bilirrubina Directa (BD)', diagnostico: 'control de laboratorio' },
            { descripcion: 'TP (Tiempo de Protrombina)', diagnostico: 'control de laboratorio' },
            { descripcion: 'Albúmina', diagnostico: 'control de laboratorio' },
            { descripcion: 'TSH', diagnostico: 'control de laboratorio' },
            { descripcion: 'T4', diagnostico: 'control de laboratorio' },
            { descripcion: 'Calcemia', diagnostico: 'control de laboratorio' },
            { descripcion: 'Fosfatemia', diagnostico: 'control de laboratorio' },
            { descripcion: 'Vitamina D3', diagnostico: 'control de laboratorio' },
            { descripcion: 'Vitamina B12', diagnostico: 'control de laboratorio' },
            { descripcion: 'Ferremia', diagnostico: 'control de laboratorio' },
            { descripcion: 'Transferrina', diagnostico: 'control de laboratorio' },
            { descripcion: 'Ferritina', diagnostico: 'control de laboratorio' },
            { descripcion: 'PSA', diagnostico: 'control de laboratorio' },
            { descripcion: 'DHEA-S', diagnostico: 'control de laboratorio' },
            { descripcion: 'Cortisol Matutino', diagnostico: 'control de laboratorio' },
            { descripcion: 'Testosterona Total', diagnostico: 'control de laboratorio' },
            { descripcion: 'Testosterona Libre', diagnostico: 'control de laboratorio' },
            { descripcion: 'Estradiol', diagnostico: 'control de laboratorio' },
            { descripcion: 'LH', diagnostico: 'control de laboratorio' },
            { descripcion: 'FSH', diagnostico: 'control de laboratorio' },
            { descripcion: 'GLAE', diagnostico: 'control de laboratorio' },
        ],
    },
    {
        id: 'vacio',
